    ...
    return (
        <section className={cls.coursesTeamSection}>
            <div className={cls.coursesTeamContainer}>
                <h1 className={cls.coursesTeamTitle}>Познакомитесь c<br/> командой "Практикум"</h1>
                    ...
                    {teachers.map(t => (
                        <div className={cls.cards}>
                            ...
                            <div className={cls.right}>
                                ...
                                <p>{t.description}тут description Lorem ipsum dolor sit amet consectetur adipisicing
                                    elit. Unde natus quam amet aut ullam repudiandae facere, sint, hic quo sit dolores
                                    sunt in sapiente odit exercitationem mollitia. Excepturi, mollitia. Nobis voluptatum
                                    voluptatem expedita exercitationem consectetur sint deleniti libero iste nulla!</p>
